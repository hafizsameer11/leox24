      ...
      <div className="rounded-2xl border border-line bg-white">
        ...
        <div className="p-5">
          {activeTab === 'overview' && <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <DetailSection title={t('customerDetail.additionalInformation')}><Detail label={t('customerForm.category')} value={customer.category?.name} /><Detail label={t('customerForm.code')} value={customer.customer_code} /><Detail label={t('customerForm.group')} value={customer.customer_group} /><Detail label={t('customerForm.fromDateOfBirth')} value={formatDate(customer.date_of_birth_from)} /><Detail label={t('customerForm.toDateOfBirth')} value={formatDate(customer.date_of_birth_to)} /><Detail label={t('customerForm.placeOfBirth')} value={customer.place_of_birth} /><Detail label={t('customerForm.cityOfBirth')} value={customer.city_of_birth} /><Detail label={t('customerForm.taxCode')} value={customer.tax_code} /><Detail label={t('customerForm.vatNumber')} value={customer.vat} /><Detail label={t('customerForm.dateAdded')} value={formatDate(customer.date_added)} /><Detail label={t('customerDetail.created')} value={formatDateTime(customer.created_at)} /><Detail label={t('customerDetail.operator')} value={customer.created_by?.name} /></DetailSection>
